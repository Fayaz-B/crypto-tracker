...
const AllCurrencies = ({ limited }) => {
  ...
  return (
    <>
      {!limited && <Divider orientation="left">Crypto Currencies</Divider>}
      <Row>
        {!limited && (
